...
QT_MOC_LITERAL(3, 21, 14), // "sendDataSignal"
QT_MOC_LITERAL(4, 36, 17) // "receiveApiMsgSlot"

    },
    "MyThread\0sendSignal\0\0sendDataSignal\0"
    "receiveApiMsgSlot"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendDataSignal((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 2: _t->receiveApiMsgSlot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::sendSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyThread::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::sendDataSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::sendSignal(QString _t1)
{
...
// SIGNAL 1
void MyThread::sendDataSignal(QByteArray _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
